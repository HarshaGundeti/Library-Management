...
public class AddBooks extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTextField1.setBounds(new java.awt.Rectangle(81, 32, 32, 32));

        jTextField2.setBounds(new java.awt.Rectangle(81, 32, 32, 32));

        jTextField3.setToolTipText("");
        jTextField3.setBounds(new java.awt.Rectangle(81, 32, 32, 32));

        jTextField4.setBounds(new java.awt.Rectangle(81, 32, 32, 32));

        jTextField5.setBounds(new java.awt.Rectangle(81, 32, 32, 32));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String numberOfCopies=jTextField3.getText();
        String genre=jTextField4.getText();
        String location=jTextField5.getText();
        TestRun tr=new TestRun();
        DataWriting dw=tr.returnObjw();
        dw.control(Name, Author, numberOfCopies, genre, location);
        new dialogbox("Added book successfully");
